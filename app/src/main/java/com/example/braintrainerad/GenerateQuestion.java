...
//                Arrays.sort(bigNumb);
    ...
    private void insertUser(){
        ...
        int gameTime2 = (gameTime-100)/1000;
        ...
        api.insertUser(
                ...
                new Callback<Response>() {
                    ...
                    public void success(Response result, Response response) {
                        ...
                        Toast.makeText(GenerateQuestion.this, output, Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void failure(RetrofitError error) {
                        //If any error occured displaying the error as toast
                        Toast.makeText(GenerateQuestion.this, error.toString(),Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
